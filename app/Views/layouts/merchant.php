...
$ses_store_name = session()->get('store_name');
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                <a href="<?= site_url('products/merchant'); ?>"
                                ...
                                <a href="<?= site_url('transactions/merchant'); ?>"
                                    class="font-medium text-gray-100 hover:text-gray-300 relative">
                                    Transaksi
                                    <span
                            ...
                            <div class="relative ml-3">
                                <div class="flex items-center cursor-pointer" id="user-menu-button">
                                    <img class="h-8 w-8 rounded-full" src="<?= base_url() ?>assets/images/user.png"
                                        alt="">
                                    <div class="ml-3 text-base font-medium leading-none text-white"><?= $ses_store_name ?>
            ...
            <div class="md:hidden" id="mobile-menu" class="hidden">
                ...
                <div class="border-t border-gray-700 pb-3 pt-4">
                    <div class="flex items-center px-3">
                        ...
                        <div class="ml-3">
                            <div class="text-base font-medium leading-none text-white"><?= $ses_store_name ?></div>
